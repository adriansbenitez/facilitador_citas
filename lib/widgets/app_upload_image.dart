  ...
  Future<void> _uploadImage() async {
    ...
    try {
      ...
      if (response.message == "Success") {
        ...
        final item = ImageModel.fromDataImage(response.response.imgUrl);
        if (item != null) {
          UserModel currenUser = AppBloc.userCubit.state!;
          currenUser.urlLogo = item.full;
          AppBloc.userCubit.onSaveUser(user);
        }
        widget.onChange(item);
      } else {
        AppBloc.messageCubit.onShow(response.message, MessageStatusType.error);
      }
    } catch (e) {
      AppBloc.messageCubit.onShow(e.toString(), MessageStatusType.error);
    }
  }
